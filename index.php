        ...
        <div class="column">
                    ...
                    <div class="large-4 medium-6 small-12 columns">
                        ...
                        <select
                            ...
                            <?php foreach ($categories as $category) { ?>
                                <option value="<?php echo $category->id ; ?>" <?php echo $sticky->select('category',$category->id) ;?> >
                    ...
                    <div class="large-4 medium-6 small-12 columns">
                        ...
                        >
                            ...
                            <?php foreach ($authors as $author) { ?>
                                <option value="<?php echo $author->id ; ?>"  <?php echo $sticky->select('author',$author->id) ;?> >
                    ...
                    <div class="large-4 medium-6 small-12 columns">
                        ...
                        >
                            ...
                            <?php foreach ($years as $year) { ?>
                                <option value="<?php echo $year->year ; ?>" <?php echo $sticky->select('year',$year->year) ;?> >
                                    <?php echo $year->year ; ?>
                                </option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="large-4 medium-6 small-12 columns">
                        ...
                        >
                            ...
                            <?php foreach ($languages as $language) { ?>
                                <option value="<?php echo $language->id ; ?>" <?php echo $sticky->select('language',$language->id) ;?> >
            ...
            <?php  }  else { ?>
             ...
             <table class="table-list">
                    ...
                    <tr>
                        <td>
                            ...
                            <small>
                                ...
                                <strong>Year: <?php  echo $book->year ;?></strong> , <strong>Price: </strong> <?php echo $book->price(); ?> <br />
                                <strong>Category: <?php  echo $book->category ;?></strong> , <strong>Cover types:</strong> <?php echo $book->covers(); ?> <br />
                ...
                <div class="center"><?php echo $books->pagination(); ?></div>
