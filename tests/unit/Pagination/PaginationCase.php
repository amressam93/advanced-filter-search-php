...
abstract class PaginationCase extends TestCase
{
     ...
     * @return Pagination
     */
    public function pagination($records_count, $per_page = 10, $key = 'page')
    {
     ...
     */
    public function selectPagintionView($records_count, $per_page = 10, $key = 'page')
    {
        return new SelectPaginationView(

          $this->pagination($records_count,$per_page,$key)
