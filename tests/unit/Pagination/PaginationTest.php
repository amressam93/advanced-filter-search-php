...
class PaginationTest extends PaginationCase
{
    ...
    public function returns_correct_limit()
    {
        ...
        $this->assertEquals(99,$pagination->limit());
    }
    ...
    public function sets_pagination_key()
    {
        ...
        $this->assertEquals(20,$pagination->offset());
        $this->assertEquals('pg',$pagination->key());
     ...
     * @test
     */
    public function get_total_number_of_records()
    {
        $pagination = $this->pagination(100,10);

        $this->assertEquals(100,$pagination->numberOfRecords());
    ...
    public function identifies_current_page()
    {
        ...
        $this->assertTrue($pagination->isCurrentPage($value));


        $this->assertFalse($pagination->isCurrentPage(22));
    ...
    public function returns_instance_of_request()
    {
        ...
        $this->assertInstanceOf(Request::class,$pagination->request());
    ...
    {
        $pagination = $this->pagination(100,10);
        $this->assertEquals($this->urlWithQuery(['page' => 9],true),$pagination->url(9));
    }
    ...
    public function returns_previous_page_url()
    {
        $_GET['page'] = 3;
        $pagination = $this->pagination(100,10);
        $this->assertEquals($this->urlWithQuery(['page' => 2],true),$pagination->previousUrl());
    ...
    public function returns_current_page_url()
    {
        $_GET['page'] = 3;
        $pagination = $this->pagination(100,10);
        $this->assertEquals($this->urlWithQuery(['page' => 3],true),$pagination->currentUrl());
    ...
    public function returns_next_page_url()
    {
        $_GET['page'] = 3;
        $pagination = $this->pagination(100,10);
        $this->assertEquals($this->urlWithQuery(['page' => 4],true),$pagination->nextUrl());
