...
class Pagination
{
     ...
     * @param string $key
     */
    public function __construct(Request $request, $records_count, $per_page = 10, $key = 'page')
    {
    ...
    {
        $this->current = $this->getCurrenPage($this->request->get($this->key));
    }
     ...
     * @return int
     */
    private function getCurrenPage($current_page = null)
    {
    ...
    /**
     * Check if Argument mathces current page.
     *
     * @param mixed $value
     * @return bool
     */
