...
abstract class Query
{
     ...
     */
    public function __construct($field, SubQuery $sub_query = null,$replace_sub_query = false)
    {
    ...
    {
        return ($this->sub_query instanceof SubQuery);
    }
    ...
    /**
     * Replace placeholder with value directly within the sub-query.
     *
     * @param mixed $value
     * @return null|string
     */
    ...
    /**
     * check if value should be  placed directly in the sub-query.
     * @return bool
     */
