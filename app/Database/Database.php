...
abstract class Database
{
    ...
    /**
     * Delegates method call to underline PDO Object Instance Method.
     *
     * @param $attribute
     * @param $value
     */
     ...
     */
    public function execute($sql, array $parameters = [], array $driver_options = [], $return = true)
    ...
    private function statement($sql, array $driver_options = [])
    {
        ...
        if(! $statement)
        {
            throw new PDOException("Query Statement Faild");
        }
     ...
     * @return mixed
     */
    public function fetchObject($sql, $parameters = null, $className = null, array $constructorArguments = [])
     ...
     * @return PDOStatement
     */
    public function query($sql, array $parameters = [], array $driver_options = [])
    {
        return $this->execute(
            $sql,
            $parameters,
     ...
     * @return array
     */
    public function fetchObjects($sql, $parameters = null, $className ='stdClass', array $constructorArguments = [])
    {
        $className = $className ?: 'stdClass';
