...
abstract class Model
{
    ...
    public function create(array $values)
    {
        ...
        {
            throw new Exception("Record Can Not Be Added");
        }
    ...
    {
        return Container::get('db')->fetchObject($this->sql()."WHERE `{$this->table}`.`{$field}` = ?",$id,static::class);
    }
    ...
    public function all()
    {
        return Container::get('db')->fetchObjects($this->fullStatement(),$this->statement_values,static::class);
    }
    ...
    /**
     *  Add order by statement to a collection of statements.
     *
     * @param string $field
     * @param string $direction
     * @return void
    ...
    {
        $count = Container::get('db')->count($this->table,$this->statement(),$this->statement_values);
